...
export default function GridLayoutSection() {
  ...
  return (
    <div className="p-4">
      <h1 className="text-3xl font-bold text-center mb-4">Responsive Grid Layout with Media Queries</h1>
      ...
      {/* Grid Example using Media Queries */}
      <motion.div
      ...
      <div className="mt-6">
        ...
        <p className="text-gray-600 mb-4">
          The layout changes dynamically based on the selected view (Mobile, Tablet, Desktop) using CSS Grid and Media Queries.
        </p>
...
/* Tablet View (maximum width of 768px) */
...
/* Mobile View (maximum width of 480px) */
